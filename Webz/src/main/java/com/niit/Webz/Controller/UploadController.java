...
public class UploadController {
	...
	try {
	   ...
	   while (itr.hasNext()) {
	        ...
	        java.nio.file.Path path = Paths.get("C://Users//Administrator//workspace//WebzFrontent//WebContent//images" + filename);
	...
	return null;
	 ...
	 public ResponseEntity<String> uploadFile(@RequestParam("file") MultipartFile file ,@PathVariable("userId") String userId ){
	  ...
	  String originalFilename = file.getOriginalFilename();
	     ...
	     File destinationFile = new File("C://Users//Administrator//workspace//.metadata//.plugins//org.eclipse.wst.server.core//tmp0//wtpwebapps//WebzFrontent//images//"+userId+".jpg");
	     try {
	                 
	      file.transferTo(destinationFile);
	      UserDetails users= userdetailsDao.getUserByUserId(userId);
	     users.setImage("/WebzFrontent/images/"+userId+".jpg"); 
